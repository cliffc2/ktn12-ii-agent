    ...
    <div className="min-h-screen grid-bg relative overflow-hidden">
      <div className="max-w-[1600px] mx-auto px-4 py-6">
        <header
          ...
          className="flex flex-col md:flex-row items-start md:items-center justify-between gap-4 mb-6 pb-4 border-b border-[hsl(0_0%_10%)]"
        >
          <div data-design-id="header-logo" className="flex items-center gap-3">
            <div
              data-design-id="header-dot"
              className="w-2.5 h-2.5 bg-emerald-400 rounded-full glow-pulse"
            />
            <h1
              data-design-id="header-title"
              className="text-lg font-bold tracking-wider text-glow text-emerald-400"
            >
              KASPA TN12
            </h1>
            <span
              data-design-id="header-subtitle"
              className="text-xs text-[hsl(0_0%_40%)] tracking-wide"
            >
              Dashboard
            </span>
          </div>
          <div
            data-design-id="header-badges"
            className="flex items-center gap-3 flex-wrap"
          >
            <div
              data-design-id="header-version"
              className="px-3 py-1.5 bg-[hsl(0_0%_5%)] border border-[hsl(0_0%_10%)] rounded text-[10px]"
            >
              <span className="text-[hsl(0_0%_40%)]">Kaspad </span>
              <span className="text-emerald-400 font-bold">v1.1.0</span>
            </div>
            <div
              data-design-id="header-network"
              className="px-3 py-1.5 bg-[hsl(0_0%_5%)] border border-[hsl(0_0%_10%)] rounded text-[10px]"
            >
        ...
        <section data-design-id="services-section" className="mb-6">
          <ServiceControl />
        </section>

        <section data-design-id="wallets-section" className="mb-6">
          <div
            data-design-id="wallets-section-header"
            className="text-[10px] text-[hsl(0_0%_35%)] uppercase tracking-widest mb-3"
          >
            Wallets
          </div>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-3">
            ...
            <WalletCard
              ...
              delay={0.15}
            />
            <WalletCard id="c" title="Wallet C — Send From" delay={0.2} />
          </div>
        </section>

        <section data-design-id="agent-section" className="mb-6">
          <div
            data-design-id="agent-section-header"
            className="text-[10px] text-[hsl(0_0%_35%)] uppercase tracking-widest mb-3"
          >
            Arbitrage Agent
          </div>
        ...
        <section data-design-id="atomic-swap-section" className="mb-6">
          <div
            data-design-id="atomic-swap-section-header"
            className="text-[10px] text-[hsl(0_0%_35%)] uppercase tracking-widest mb-3"
          >
            Atomic Swaps
          </div>
        ...
        <section data-design-id="deadman-section" className="mb-6">
          <div
            data-design-id="deadman-section-header"
            className="text-[10px] text-[hsl(0_0%_35%)] uppercase tracking-widest mb-3"
          >
            Deadman Switch
          </div>
        ...
        <section data-design-id="contracts-section" className="mb-6">
          <div
            data-design-id="contracts-section-header"
            className="text-[10px] text-[hsl(0_0%_35%)] uppercase tracking-widest mb-3"
          >
            Smart Contracts
          </div>
        ...
        <section data-design-id="rpc-section" className="mb-6">
          <div
            data-design-id="rpc-section-header"
            className="text-[10px] text-[hsl(0_0%_35%)] uppercase tracking-widest mb-3"
          >
            RPC Tester & Console
          </div>
        ...
        <footer
          data-design-id="dashboard-footer"
          className="py-4 border-t border-[hsl(0_0%_10%)] text-center text-[10px] text-[hsl(0_0%_25%)]"
        >
          <span data-design-id="footer-text">
            KASPA TN12 Dashboard — Testnet 12 (Covenant) — v1.1.0
          </span>
          <span data-design-id="footer-links" className="mx-2">
            |
          </span>
          <span data-design-id="footer-ports" className="text-[hsl(0_0%_35%)]">
            gRPC:16210 wRPC:17210 P2P:16311
          </span>
        </footer>
      </div>
    </div>
